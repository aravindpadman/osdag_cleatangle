...
from ui_cleat import Ui_MainWindow
from model import *
from Connections.Shear.Finplate.cleatCalc import cleatAngleConn
import yaml
import pickle
...
from Connections.Shear.Finplate.angle import Plate
...
#         uiObj['cleat']['Width (mm)'] = self.ui.txtPlateWidth.text().toInt()[0]
#         uiObj['Cleat']['Thickness (mm)']= float(8)
        uiObj['Load'] = {}
...
#         outObj['Weld']["Weld Strength (kN/mm)"] = float(self.ui.txtWeldStrng.text())
        ...
        outObj['Bolt']["No.Of Column"] = int(self.ui.txt_column.text())
